...
module.exports = (homebridge) => {
  ...
  homebridge.registerAccessory('homebridge-esp-gesture', 'ESPGESTUREb', ESPGESPluginb);
};
...
class ESPGESPluginb
{
  constructor(log, config) {
    ...
    this.informationService
      .setCharacteristic(Characteristic.Manufacturer, "ESP")
      .setCharacteristic(Characteristic.Model, "ESPEasyGestureb")
      .setCharacteristic(Characteristic.SerialNumber, this.device);
	  
	this.switch1Service = new Service.StatelessProgrammableSwitch(this.name + '2');
//	this.switch2Service = new Service.StatelessProgrammableSwitch(this.name + '2');
